...
class SentimentAnalyzer:
    ...
    def evaluate(self, dataloader):
        ...
        report = classification_report(all_labels, all_preds, target_names=self.labels, output_dict=True)
    ...
    def predict_text(self, 
        ...
        for i in range(0, len(texts), batch_size):
            ...
            # Get predictions
            batch_predictions = self.predict(inputs, return_probabilities=return_probabilities)
